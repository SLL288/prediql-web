...
def main():
    ...
    # 5️⃣ Save to YAML
    with open("query_parameter_list.yml", "w", encoding="utf-8") as f:
    ...
    if mutation_parameters:
        with open("mutation_parameter_list.yml", "w", encoding="utf-8") as f:
    ...
    with open("object_list.yml", "w", encoding="utf-8") as f:
